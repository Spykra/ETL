...
checkpoint_path = os.path.join(checkpoint_dir, 'latest_checkpoint.pth')  # Corrected to check for specific checkpoint file
...
for epoch in range(start_epoch, epochs):
    ...
    for i, (imgs, _) in enumerate(dataloader):
        ...
        save_checkpoint(epoch, generator, discriminator, g_optimizer, d_optimizer, checkpoint_path, i)

        # Optionally save historical checkpoints
        if epoch % 10 == 0:
